...
if __name__ == '__main__':
    p = Person(10)
    print(f"Person is 10 years old and not responsible. He is {p.drink()}")
    rp = ResponsiblePerson(p)
    print(f"Person is 10 years old and responsible. He is {rp.drink()}")
    rp.age = 20
    print(f"Person is 20 years old and responsible. He is  {rp.drink()}")